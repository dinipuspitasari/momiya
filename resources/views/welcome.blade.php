...
<section class="bg-center bg-no-repeat bg-gray-100 bg-blend-multiply" id="section" style="background-image: url('/assets/img/bg2.png');">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 class="mb-4 text-4xl font-bold tracking-tight leading-none text-green-500 md:text-5xl lg:text-6xl pt-8">Momiya Medical clinic</h1>
...
<div class="fasilitas px-4 sm:px-10 md:px-32 pt-10 bg-gray-50">
    ...
    <div id="carousel-product" class="relative w-full" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-48 sm:h-56 lg:max-h-60 overflow-hidden rounded-lg">
            <!-- First Slide -->
            <div class="duration-700 ease-in-out" data-carousel-item>
                <div class="flex items-center gap-4 sm:gap-8 px-4 sm:px-10 lg:px-20">
                    ...
                    <div class="flex-1 border border-gray-200 rounded-lg shadow-md">
                        <img class="rounded-t-lg w-full h-32 sm:h-40 object-cover" src="/assets/img/fasilitas 1.jpg" alt="" />
                    </div>
                    <!-- Card 2 -->
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <div class="flex items-center gap-4 sm:gap-8 px-4 sm:px-10 lg:px-20">
                    <!-- Card 4 -->
                    <div class="flex-1 bg-white border border-gray-200 rounded-lg shadow-md">
                        <img class="rounded-t-lg w-full h-32 sm:h-40 object-cover" src="/assets/img/fasilitas 1.jpg" alt="Multitek" />
                    </div>
                    <!-- Card 5 -->
                    <div class="flex-1 bg-white border border-gray-200 rounded-lg shadow-md">
                        <img class="rounded-t-lg w-full h-32 sm:h-40 object-cover" src="/assets/img/fasilitas 1.jpg" alt="Relpol" />
                    </div>
                    <!-- Card 6 -->
                    <div class="flex-1 bg-white border border-gray-200 rounded-lg shadow-md">
                        <img class="rounded-t-lg w-full h-32 sm:h-40 object-cover" src="/assets/img/fasilitas 1.jpg" alt="Starco" />
                    </div>
                </div>
            </div>
        </div>
...
<h1 class="text-6xl font-bold text-center mb-2 text-gray-800 mt-5">Galeri</h1>
    <div class="container-gallery px-5">
        <img src="/assets/img/2.jpg" alt="Herd of horses">
        <img src="/assets/img/2.jpg" alt="Baby Elephant">
        <img src="/assets/img/2.jpg" alt="Koi Fish">
        <img src="/assets/img/2.jpg" alt="Ibis Bird">
        <img src="/assets/img/2.jpg" alt="Lemur">
        <img src="/assets/img/2.jpg" alt="Berber Monkeys">
    </div>
</div>
{{-- galeri end --}}
