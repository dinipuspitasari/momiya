...
<!-- Hero Section -->
<nav class="flex pt-32 mx-5 md:mx-28" aria-label="Breadcrumb">
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="/about" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Tentang Kami</a>
      </div>
    </li>
  </ol>
</nav>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div class="grid md:grid-cols-2">
            <div class="flex items-center justify-center">
               <img class="w-90 h-90 object cover rounded-lg" src="/assets/img/5.jpg" alt="Momiya">
            </div>
            <div class="flex">
                <div class="px-4 py-6">
                    <h1 class="text-6xl font-bold mb-2 text-gray-800">Tentang</h1>
                    <h1 class="text-4xl font-bold mb-8 underline text-green-500">Momiya Medical Clinic</h1>
                <br>
                <p class="text-lg font-normal text-gray-900  mb-4">Momiya Medical Klinik adalah klinik khusus anak yang menyediakan layanan kesehatan terbaik untuk tumbuh kembang si kecil. Dengan tenaga medis profesional dan fasilitas modern, Momiya Medical Klinik berkomitmen memberikan perawatan yang nyaman, ramah, dan sesuai kebutuhan kesehatan anak Anda. Klinik ini hadir sebagai solusi terpercaya untuk keluarga yang mengutamakan kesehatan buah hati.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="bg-blue-100 py-8 px-4">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 text-center gap-8">
        ...
        <div>
            ...
            <p class="text-gray-400">Poliklinik</p>
        </div>
        <div>
...
<section>
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div class="grid md:grid-cols-2">
            <div class="px-4 py-6">
                    <h1 class="text-6xl font-bold mb-2 text-gray-800">Filosofi</h1>
                    <h1 class="text-4xl font-bold mb-8 underline text-green-500">Visi, Misi, Motto dan Tujuan</h1>
                <br>
                <p class="text-lg font-normal text-gray-900  mb-4">Momiya Medical Klinik adalah klinik khusus anak yang menyediakan layanan kesehatan terbaik untuk tumbuh kembang si kecil. Dengan tenaga medis profesional dan fasilitas modern, Momiya Medical Klinik berkomitmen memberikan perawatan yang nyaman, ramah, dan sesuai kebutuhan kesehatan anak Anda. Klinik ini hadir sebagai solusi terpercaya untuk keluarga yang mengutamakan kesehatan buah hati.</p>
                </div>
            <div class="flex">
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-1">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mt-4">Dr. Inge Novarina</h3>
                <p class="text-gray-400">Umum</p>
            </div>
            <div class="text-center">
                <img src="https://via.placeholder.com/150" alt="Team Member" class="rounded-lg mx-auto">
                <h3 class="text-xl font-bold mt-4">Dr. Ronny</h3>
                <p class="text-gray-400">Laktasi</p>
            </div>
            <div class="text-center">
                <img src="https://via.placeholder.com/150" alt="Team Member" class="rounded-lg mx-auto">
                <h3 class="text-xl font-bold mt-4">Dr. Patricia</h3>
                <p class="text-gray-400">umum</p>
            </div>
            <div class="text-center">
                <img src="https://via.placeholder.com/150" alt="Team Member" class="rounded-lg mx-auto">
                <h3 class="text-xl font-bold mt-4">Dr. Henry</h3>
                <p class="text-gray-400">Psikolog Klinis Anak</p>
            </div>
        </div>
    </div>
</section>
...
<footer class="bg-white dark:bg-gray-900">
      ...
      <div class="md:flex md:justify-between md:items-center">
        ...
        <div class="mb-6 md:mb-0">
          <a href="/" class="flex items-center">
            <img src="/assets/img/logo.png" class="h-14 me-3" alt="Logo" />
          </a>
          <p class="text-gray-900 pt-3">Momiya Medical Klinik adalah klinik khusus anak yang menyediakan layanan <br> kesehatan terbaik untuk tumbuh kembang si kecil. </p>
        </div>
        <!-- Links Section -->
        <div class="grid grid-cols-2 gap-8 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-gray-500 font-semibold">
                    ...
                    <li>
                        <a class="hover:underline">momiya@gmail.com</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center">© 2024 <a href="/" class="hover:underline">Momiya Medical Clinic™</a>. All Rights Reserved.
        </span>
