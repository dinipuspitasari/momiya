  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="/faq" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Bantuan</a>
      </div>
    </li>
  </ol>
</nav>
...
{{-- faq start --}}
<div id="accordion-collapse" data-accordion="collapse" class="pt-8 md:px-32 px-10">
